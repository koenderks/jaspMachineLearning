...
mlRegressionLinear <- function(jaspResults, dataset, options, ...) {
  ...
  .mlPlotDataSplit(dataset, options, jaspResults, ready, position = 3, purpose = "regression", type = "lm")
  ...
  .mlRegressionLinearTableCoef(options, jaspResults, ready, position = 7)
